...
const WoundClinicConsole: React.FC = () => {
    ...
    const captureAndAnalyze = async () => {
        ...
        try {
            ...
            const result = await PhoenixAPI.analyzeMultimodal(b64Image, 'Identify wound characteristics and tissue integrity.');
    ...
    const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        reader.onloadend = async () => {
            ...
            try {
                const result = await PhoenixAPI.analyzeMultimodal(base64String);
                setMultimodalResult(result);
            } catch (err) {
                console.error(err);
