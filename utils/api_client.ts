...
export const PhoenixAPI = {
    ...
    diagnoseTissue: async (tissueType: string, options: { patientId?: string, woundLocation?: string, resvech_params?: any } = {}) => {
        const { patientId = 'P-DEMO', woundLocation = 'Primary', resvech_params } = options;
    ...
    archiveImage: async (patientId: string, woundLocation: string, imageB64: string) => {
