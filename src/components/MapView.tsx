...
import { Icons, calculateAge, PROGRAMAS } from '../constants';
            ...
            <div className="flex flex-col space-y-4 mb-4">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    ...
                    <div className="flex gap-1 w-full md:w-auto">
                        <input
                            ...
                            onKeyDown={(e: React.KeyboardEvent<HTMLInputElement>) => e.key === 'Enter' && handleAddressSearch()}
                        />
                        <button
                ...
                <div className="bg-white p-3 rounded-lg shadow-sm border border-gray-200 flex flex-wrap gap-3 items-end">
                    ...
                    <div className="flex-1 min-w-[150px]">
                        ...
                        <select
                            value={radiusFilter}
                            onChange={(e: React.ChangeEvent<HTMLSelectElement>) => setRadiusFilter(Number(e.target.value))}
                            className="w-full px-3 py-2 border border-gray-300 bg-white rounded-md text-sm focus:outline-none focus:ring-brand-lightblue"
                        >
                        ...
                        {selectedPatient && (
                            <Card title="Paciente Seleccionado" className="animate-fade-in">
                                <div>
                                    ...
                                    <span className={`px-2 py-1 text-xs font-semibold rounded-full ${selectedPatient.estado === 'Aceptado' ? 'bg-green-100 text-green-800' :
